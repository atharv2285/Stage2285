...
import { Github, Linkedin, Mail, Edit2, Plus } from 'lucide-react'
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        >
          ...
          <div className="flex gap-4 mb-6">
            {user.github_url && (
              <a href={user.github_url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-gray-600 hover:text-primary-600">
                <Github size={20} />
                <span>GitHub</span>
              </a>
            )}
            {user.linkedin_url && (
              <a href={user.linkedin_url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-gray-600 hover:text-primary-600">
                <Linkedin size={20} />
                <span>LinkedIn</span>
              </a>
            )}
            <a href={`mailto:${user.email}`} className="flex items-center gap-2 text-gray-600 hover:text-primary-600">
              <Mail size={20} />
              <span>Email</span>
            </a>
          </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {user.interests.map((interest, index) => (
                  <span key={index} className="px-3 py-1 bg-orange-50 text-primary-700 rounded-full text-sm">
                    {interest}
                  </span>
                ))}
              </div>
          ...
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            ...
            <form onSubmit={(e) => {
              ...
              <div className="flex gap-2">
                <button type="submit" className="flex-1 bg-primary-600 text-white py-2 rounded-lg hover:bg-primary-700">Add</button>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            ...
            <form onSubmit={(e) => {
              ...
              <div className="flex gap-2">
                <button type="submit" className="flex-1 bg-primary-600 text-white py-2 rounded-lg hover:bg-primary-700">Post</button>
